        ...
        <div class="footer-wrapper">
            <a href="<?php echo get_page_link(apply_filters('wpml_object_id', 18286, 'page')); ?>"
               class="accreditations" title="<?php _e("Our accreditations and labels", "ieseg2020") ?>">
                <img src="<?php echo get_template_directory_uri() . '/img/logos/logos_accreditations-et-labels_exec.png' ?>"
        ...
        <div class="footer-wrapper">
            <div class="footer-signature">
                ...
                <p class="footer-baseline">
                    <img src="<?php echo get_template_directory_uri() . '/img/logos/baseline_footer_exec.svg' ?>"
