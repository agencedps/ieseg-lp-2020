...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    ...
    if (ICL_LANGUAGE_CODE != "zh-hans") {
                ...
                <div class="testimonials">
                        ...
                        <article class="testimonial">
                            ...
                            <div class="infos">
                                <h3 class="titre"><a href="http://ieseg.test/testimonial/yeonhae-ann-lee/"
                                                     title="Yeonhae (Ann) Lee" tabindex="-1">Yeonhae (Ann) Lee</a></h3>
                                <p class="meta">MSc in Fashion Management, 2014</p>
                            </div>
                            <div class="testi-excerpt">J’ai vécu chaque minute passée à l’IÉSEG à cent à l’heure, avec
                                son lot de nouvelles expériences et de découvertes. L’année à l’IÉSEG à Paris a été une
                    ...
                    <div class="testi-slide">
                        <article class="testimonial">
                            ...
                            <div class="testi-excerpt">Anne-Lise Miart est entrée à l’IÉSEG en 2006 et elle prend
                                rapidement la décision de partir en échange au Chili pour sa deuxième année. De retour à
                                Lille, elle s’investit dans son projet Co « Speed Recruit’in Lille ». Ce projet sera un
                                véritable succès&nbsp;!
                    ...
                    <div class="testi-slide">
                        <article class="testimonial">
                            ...
                            <div class="testi-excerpt">Avant de rejoindre l’IÉSEG, j’ai obtenu un Bachelor en Génie
                                ...
                                poursuivre mes études au sein d’un établissement qui me permettrait d’établir un pont
                                entre ma formation technique et mon envie de travailler dans le domaine du conseil.

                                J’ai été attiré par le Master of Science in Business Analysis &amp; Consulting et par le
                    ...
                    <div class="testi-slide">
                        <article class="testimonial">
                            ...
                            <div class="testi-excerpt">Pour moi, l’expérience culturelle ainsi que la chance d’étudier à
                                l’IÉSEG&nbsp; ont été très épanouissants.

                                J’ai toujours rêvé de faire un MBA depuis l’obtention de mon Bachelor à l’université de
                                Floride en 2009.

                                Aujourd’hui, dans le marché actuel, la concurrence est rude c'est d'autant plus
                                important d’avoir une valeur ajoutée pour pouvoir se différencier des autres. C'est ce
                        ...
                        <article class="testimonial">
                            ...
                            <div class="infos">
                                <h3 class="titre"><a href="http://ieseg.test/testimonial/raphaelle-dessein/"
                                                     title="Raphaëlle Dessein" tabindex="-1">Raphaëlle Dessein</a></h3>
                                <p class="meta">Programme Grande École, 2013</p>
                            </div>
                            <div class="testi-excerpt">Après l’obtention de mon bac ES à Lille, j’ai su immédiatement
                                que le commerce serait ma voie. Je désirais avant tout une formation qui me permette une
                    ...
                    <div class="testi-slide">
                        <article class="testimonial">
                            ...
                            <div class="testi-excerpt">Mon premier emploi fut celui de collaborateur de Maître BECQUET,
                                Administrateur Judiciaire sur la métropole lilloise. Je connaissais assez peu le métier
                                mais j’ai été séduit par la diversité des missions, la variété des secteurs d’activité
        ...
        <div class="see-all">
            <a href="http://ieseg.test/testimonial/" title="Tous les témoignages" class="btn btn-blanc">Tous les
                témoignages</a>
        </div>
        </div>
        </section>
    ...
    <section class="form-container">
        <div class="form-wrapper">
                ...
                <p><em>Receive the brochure with program content, scholarship information &amp; application process</em></p>
