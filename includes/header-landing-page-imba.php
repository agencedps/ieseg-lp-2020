<?php
/**
 * Header de la landing-page IMBA
 *
 */
...
if(is_page(22)){ 
	...
	$punchline_footer="Join a Top International MBA & Study in the Heart of Europe";
	...
	$keyfacts_programme = 
		...
		<div class="row">
			<div class="col-sm-6">
				<strong>ACCREDITATION:</strong> AMBA
			</div>
			<div class="col-sm-6">
				<strong>CREDITS:</strong> 90 ECTS
			</div>
		</div> 
	  ';
}
