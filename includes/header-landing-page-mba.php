<?php
/**
 * Header de la landing-page MBA
 *
 */
 
//MBA
if(is_page(691)){ 
	$url_img_une="https://www.ieseg.fr/landings/wp-content/themes/ieseg-landings-2015/images/img-une/img-landing-mba.jpg";
	$punchline_programme="at IÉSEG School of Management";
	$punchline_footer=" ";
	$tel_footer ="(+33)3.20.54.58.92";
	$mail_footer="a.banaszak@ieseg.fr";
	$keyfacts_programme = 
		'<div class="row">
			<div class="col-sm-12">
				<strong>International MBA:</strong> program in 1 year (3 terms) - Paris (France) - English
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12">
				<strong>Executive MBA:</strong> program in 24 months (part-time) - Paris (France) - French & English
			</div>
		</div>
	  ';
}
