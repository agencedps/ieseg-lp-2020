<?php
/**
 * Header de la landing-page Mastères Spécialisés
 *
 */
 
//Executive Mastères Spécialisés
if(is_page(1278)){ 
	$url_img_une="https://www.ieseg.fr/landings/wp-content/themes/ieseg-landings-2015/images/img-une/img-landing-exec-ms.jpg";
	$punchline_programme="Direction Commerciale et Business Development & Direction Marketing et Digital";
	...
	$keyfacts_programme = 
		...
		<div class="row">
			<div class="col-sm-6">
				<strong>PROCHAINE RENTRÉE :</strong> janvier 2020
			</div>
			<div class="col-sm-6">
...
?>
            ...
            <div class="text-left container-titre-programme container-titre-ms" style="background-color: rgba(252, 194, 14, 1); margin-top:0 !important; padding-bottom:4px;">
                <div class="col-sm-8">
                    ...
                    ?>
                    <div class="punchline-program" style="font-size:30px;margin-top:-15px !important;text-align:center; max-width: 970px !important;">
                        <?php echo $punchline_programme; ?>
                    </div>
                </div>
            </div>
<div id="container-img-une" style="background-image:url(<?php echo $url_img_une ?>);background-position:middle;">
</div>