<?php
/**
 * Header de la landing-page Exec MS Direction Commerciale et Business Dev.
 *
 */
 
//Executive MS Direction Commerciale et Business Dev.
if(is_page(1300)){ 
	$url_img_une="https://www.ieseg.fr/landings/wp-content/themes/ieseg-landings-2015/images/img-une/img-landing-ms-direction-comm-business-dev.jpg";
	$punchline_programme="Devenez le business partner indispensable à votre entreprise";
...
<div id="container-img-une" style="background-image:url(<?php echo $url_img_une ?>);" title="Formation manager commercial IÉSEG">
</div>